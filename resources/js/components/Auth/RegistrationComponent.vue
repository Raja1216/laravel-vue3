        ...
        <div class="shadow">
            <div class="form-horizontal my-5 px-5" id="regis-form">
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-md-3" id="sendotp" style="display:none">
                        <div class="form-group">
                            <p class="mt-4 text-center crsr_pntr"><b>Send OTP</b></p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-9" id="enterotp" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control rounded-0 emptyValidate" id="otp" name="mobile"
                                maxlength="4" placeholder="Enter OTP Send On Your Mobile">
                        </div>
                    </div>
                    <div class="col-md-3" id="verifyotp" style="display:none">
                        <div class="form-group">
                            <p class="mt-4 text-center crsr_pntr"><b>Verify OTP</b></p>
                        </div>
                    </div>
                </div> -->
                <div class="row">
